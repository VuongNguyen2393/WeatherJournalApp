...
let apiKey = '&appid=2520fbbb69466d6852b9b07264685f46';
...
const updateUI = async()=>{
    ...
    try{
        ...
        document.getElementById('temp').innerHTML  = latestData.temperature;
        document.getElementById('content').innerHTML = latestData.userResponse;
    }catch(error){
